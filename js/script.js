...
if (document.getElementById('price-filter__slider')) {
  let priceSlider = document.getElementById('price-filter__slider');
...
let compareItems = document.querySelectorAll(".compare-filter__item")
...
if (document.querySelector('.compare-filter__clean')) {
  const trash = document.querySelector('.compare-filter__clean');
  let compareFilterItems = document.querySelector('.compare-filter__items')
...
if (document.querySelector('._spoller')) {
  ...
  let spollerItems = document.querySelectorAll('._spoller-item');

  for(let i=0; i<spollers.length; i++) {
    const spoller = spollers[i];
    const item = spollerItems[i];
...
if (document.querySelector('.filter__title')) {
  ...
  $('.filter__content').slideToggle(600);
})}


if (document.querySelector('.images-product__container01')) {
  let images_subgallery = new Swiper(".images-product__container02", {
    slidesPerView: 4,
    autoHeight: true,
    speed: 800,
  ...
  let images_gallery = new Swiper(".images-product__container01", {
    slidesPerView: 1,
    autoHeight: false,
    speed: 800,

    thumbs: {
      swiper: images_subgallery
    }
  })
}

if (document.querySelector('.counter__button')) {
  let countButtons = document.querySelectorAll('.counter__button');
  for (let i = 0; i < countButtons.length; i++) {
    let countButton = countButtons[i];
    countButton.addEventListener('click', function (e) {
      let value = parseInt(countButton.closest('.counter').querySelector('input').value);

      if (countButton.classList.contains('counter__button_plus')) {
        value++;
        if (!value) {
          value = 1;
        }
      ...
      countButton.closest('.counter').querySelector('input').value = +value;
    })
  }
  
}

if (document.querySelector('.info-product__item')) {
  let tabs = document.querySelectorAll('.info-product__item');
  let blocks = document.querySelectorAll('.info-product__block');
